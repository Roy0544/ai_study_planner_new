...
export function WorkspaceContent() {
  ...
  // Local Skeleton definition for reuse in this view
  function WorkspaceSkeleton() {
    return (
      <div className="flex-grow flex flex-col h-[calc(100vh-4rem)] bg-app-bg text-text-primary animate-pulse w-full">
        {/* Top Header Mock */}
