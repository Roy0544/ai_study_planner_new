    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {recentSets.map((set, i) => (
          <LiquidGlassCard key={i} glassSize="sm" className="group border-muted/50 hover:border-primary/50 transition-all cursor-pointer hover:shadow-2xl rounded-2xl bg-transparent flex flex-col">
